# Robin Bonhoure — Développeur front-end React / Next.js (confirmé)

Toulouse (31500) · robin.bonhoure@outlook.fr · robinbonhoure.com
Recherche : CDI, **full remote** (France), front-end React/Next.js ou fullstack JS/TS (Next.js + NestJS/Node).
...
- Missions de développement web en autoentrepreneur.

### Stage — LAAS-CNRS
- Développement Python / C++ / Shell en laboratoire de recherche.

## Formation
- Formation Node.js complète (2026) — projet fullstack Next.js + NestJS déployé.
- Titre RNCP niveau 6 — Développeur d'application front-end React (OpenClassrooms).
- Master 1 Mécanique Énergétique — Université Paul Sabatier (Toulouse).
- Three.js Journey.
